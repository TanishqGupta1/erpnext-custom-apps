...
Run with: bench --site erp.visualgraphx.com execute chat_bridge.fix_workspace_refs.fix_workspace_references
"""
import frappe

def fix_workspace_references():
    """Fix all Chatwoot references in workspace shortcuts and links"""
