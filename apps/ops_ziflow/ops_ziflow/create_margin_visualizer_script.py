"""
Script to create the OPS Product Margin Visualizer Client Script
Run with: bench --site erp.visualgraphx.com execute create_margin_visualizer_script.create_client_script
"""
import frappe
...
ops_ziflow.margin_visualizer = {
                    ...
                    <div class="col-md-6">
                        <div class="margin-inputs" style="padding: 10px;">
                            <div class="margin-section" style="margin-bottom: 20px; padding: 15px; background: #fff; border-radius: 6px; border: 1px solid #dc354533;">
                                ...
                                <div class="row">
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Top</label><input type="number" step="0.0001" class="form-control margin-input" data-type="cut" data-direction="top" value="${cut_margins.top}" style="border-color: #dc354566;"></div></div>
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Right</label><input type="number" step="0.0001" class="form-control margin-input" data-type="cut" data-direction="right" value="${cut_margins.right}" style="border-color: #dc354566;"></div></div>
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Bottom</label><input type="number" step="0.0001" class="form-control margin-input" data-type="cut" data-direction="bottom" value="${cut_margins.bottom}" style="border-color: #dc354566;"></div></div>
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Left</label><input type="number" step="0.0001" class="form-control margin-input" data-type="cut" data-direction="left" value="${cut_margins.left}" style="border-color: #dc354566;"></div></div>
                                </div>
                            </div>
                            <div class="margin-section" style="padding: 15px; background: #fff; border-radius: 6px; border: 1px solid #28a74533;">
                                ...
                                <div class="row">
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Top</label><input type="number" step="0.0001" class="form-control margin-input" data-type="safe" data-direction="top" value="${safe_margins.top}" style="border-color: #28a74566;"></div></div>
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Right</label><input type="number" step="0.0001" class="form-control margin-input" data-type="safe" data-direction="right" value="${safe_margins.right}" style="border-color: #28a74566;"></div></div>
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Bottom</label><input type="number" step="0.0001" class="form-control margin-input" data-type="safe" data-direction="bottom" value="${safe_margins.bottom}" style="border-color: #28a74566;"></div></div>
                                    <div class="col-6"><div class="form-group"><label class="control-label" style="font-size: 11px; color: #666;">Left</label><input type="number" step="0.0001" class="form-control margin-input" data-type="safe" data-direction="left" value="${safe_margins.left}" style="border-color: #28a74566;"></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    bind_events: function() {
        ...
        $('.margin-visualizer-container').off('input change', '.margin-input').on('input change', '.margin-input', function() {
            const $input = $(this);
    ...
    update_svg_visualization: function() {
        ...
        $('.cut-margin-rect').attr({ x: Math.max(cut_rect.x, 55), y: Math.max(cut_rect.y, 35), width: Math.min(cut_rect.width, 190), height: Math.min(cut_rect.height, 180) });
        $('.safe-margin-rect').attr({ x: Math.max(safe_rect.x, 60), y: Math.max(safe_rect.y, 40), width: Math.min(safe_rect.width, 180), height: Math.min(safe_rect.height, 170) });
    },
...
frappe.ui.form.on('OPS Product', {
    ...
    onload: function(frm) {
        if (frm.doc.name) {
            setTimeout(() => ops_ziflow.margin_visualizer.init(frm), 500);
        }
    }
});
'''
    ...
    frappe.db.commit()
    return "Client Script created/updated successfully"
